      ...
      <AnimatePage>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                ...
                <h5 className="fs-5 md-fs-6 sm-fs-14-ss color-secondary fw-semibold mb-0">
          ...
          <div className="container position-relative">
            <div className="row gy-4">
              <div className="col-lg-4">
                ...
                >
                  <div
                    className="rounded-circle shadow-primary-ss mb-4 icon-layanan-kami"
                    style={{ width: "85px", height: "85px" }}
                  >
                    <img
                      src="/img/icon-platform.svg"
                      alt="icon"
                      className="icon-layanan-kami"
                    />
                  </div>
                  <h4 className="fs-4 md-fs-5 sm-fs-6 color-dark fw-bold mb-4">
                    Platform
                  </h4>
                  <p className="fs-18-ss md-fs-6 sm-fs-14-ss fw-semibold color-secondary mb-0">
              ...
              <div className="col-lg-4">
                ...
                >
                  ...
                  >
                    <img
                      src="/img/icon-infrastruktur.svg"
                      alt="icon"
                      className="icon-layanan-kami"
                    />
                  </div>
        ...
        <section>
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <h3 className="fs-3 md-fs-4 sm-fs-6 fw-bold color-dark">
                  Fitur Utama
                </h3>
                <h5 className="fs-5 md-fs-6 sm-fs-14-ss color-secondary color-secondary">
          ...
          <div className="container">
            ...
            <div className="row justify-content-between align-items-center pb-5 mb-5">
              ...
              <div className="col-md-5">
                <h6 className="fs-6 md-fs-14-ss fw-extrabold color-primary text-uppercase mb-4">
                  JELAJAH SEKOLAH
                </h6>
                <h3 className="fs-3 md-fs-5 sm-fs-6 fw-extrabold color-dark pt-2">
                  Jelajahi lingkungan sekolah secara virtual dengan pengalaman
                  tampilan 360°.
                </h3>
                <p className="fs-18-ss md-fs-14-ss color-secondary fw-semibold mb-0">
